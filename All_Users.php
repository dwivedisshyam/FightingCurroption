    	...
    	<div class="container">
          ...
          ================================================= -->
            ...
            <div class="profile-card">
            	...
            	<h5><a href="timeline.html" class="text-white"><?php echo $unm; ?></a></h5>
              ...
              <div class="nearby-user">
                <div class="row">
                  ...
                  <div class="col-md-7 col-sm-7">
                   ...
                   <?php
                     $query2 = "select * from followers where uid=".$rw[0]." and follower_id=".$uid;
                    //echo $query2;
                  ...
                  <div class="col-md-3 col-sm-3">
                    <a style="pointer-events: none;" href="User_Follow_Submit.php?id=<?php echo $rw[0]; ?>" class="btn btn-primary pull-right" id="fbtn">Unfollow</a>
                  </div>
                  <?php
                  }
                  else
                  ...
                  ?>
                  <div class="col-md-3 col-sm-3">
				                      <a href="User_Follow_Submit.php?id=<?php echo $rw[0]; ?>" class="btn btn-primary pull-right" id="fbtn">Follow</a>
                  </div>
                  <?php
                  }
                  ?>
