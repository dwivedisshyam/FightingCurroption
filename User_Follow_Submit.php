            ...
            <div class="row">
              ...
              <div class="col-md-9">
                ...
                <ul class="follow-me list-inline">
                  ...
                  <li><button class="btn-primary"></button></li>
                </ul>
              </div>
            </div>
        ...
        <div id="page-contents">
          <div class="row">
            ...
            <?php
		     ...
		     $query = "insert into followers (uid,follower_id) values(".$id.",".$uid.")";
             mysql_query($query);
                ...
                <div class="edit-block">
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <input id="fname" class="form-control input-group-lg" type="text" name="firstname" title="Enter first name" placeholder="First name" value='<?php echo $rw[3];?>' readonly='true' />
                      </div>
                      <div class="form-group col-xs-6">
                        <label for="lastname" class="">Last name</label>
                        <input id="lname" class="form-control input-group-lg" type="text" name="lastname" title="Enter last name" placeholder="Last name" value='<?php echo $rw[4];?>' readonly='true' />
                      </div>
                    </div>
                    <div class="row">
                      <div class="form-group col-xs-12">
                        <label for="phone">Phone Number </label>
                        <input id="phone" class="form-control input-group-lg" type="text" name="" title="Enter Phone" placeholder="Phone Number" value='<?php echo $rw[8];?>'  readonly='true' />
                      </div>
                    </div>
                    ...
                    <div class="row">
                      <div class="form-group col-xs-6">
                        ...
                        <input id="city" class="form-control input-group-lg" type="text" name="city" title="Enter city" placeholder="Your city" value='<?php echo $rw[14];}?>' readonly='true' />
                      </div>
						</div>
                </div>
              </div>
